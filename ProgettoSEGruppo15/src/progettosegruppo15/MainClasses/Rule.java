...
public class Rule implements Serializable{
    ...
    private LocalDateTime lastFired; // Last time rule was fired
    ...
    public void updateSleep() {
        ...
        LocalDateTime lastF = this.lastFired;
        LocalTime sleep = this.getSleepTime();
        // Check if lastfired + sleeptime < now
        lastF.plusHours(sleep.getHour());
        lastF.plusMinutes(sleep.getMinute());
        lastF.plusSeconds(sleep.getSecond());
        if (lastF.isBefore(LocalDateTime.now()))
            this.setActive(true);
    }
    /**
